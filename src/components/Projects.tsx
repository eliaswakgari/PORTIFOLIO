  ...
  return (
    ...
    >
      <div className="container mx-auto relative z-10">
        {/* Section Header */}
        <motion.h2
          className="text-4xl md:text-5xl lg:text-6xl font-black text-center mb-4 bg-gradient-to-r from-purple-300 via-pink-400 to-purple-300 bg-clip-text text-transparent"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {projects.map((project, index) => (
            <motion.div
              ...
              whileHover={{ y: -8, scale: 1.02, boxShadow: '0 25px 60px rgba(139, 92, 246, 0.45)' }}
            >
